...
extern uint8 I2C_Trans_Bytes(uint8 *buf, uint8 length, gpio_init_cfg_t* gpio, uint8* delay) __FAR__;
extern uint8 I2C_Recev_Bytes(uint8 *buf, uint8 address, uint8 length, gpio_init_cfg_t* gpio, uint8* delay) __FAR__;

extern int Codec_init(uint8 i2s_sn) __FAR__;
extern int Codec_exit(void) __FAR__;
extern int Codec_set_sample(uint16 sample_rate) __FAR__;
extern int Codec_set_dacgain(uint8 gain_type) __FAR__;

extern void IIC_Init(gpio_init_cfg_t* gpio, uint8* delay) __FAR__;
extern void IIC_Exit(gpio_init_cfg_t* gpio) __FAR__;
