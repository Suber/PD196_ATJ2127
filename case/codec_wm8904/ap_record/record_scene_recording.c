...
//    act_writel((act_readl(MFP_CTL2) & 0xfff8dfff), MFP_CTL2);  //I2S B0 /B567
//    act_writel((act_readl(CLKENCTL) | 0x07000), CLKENCTL);  //I2S B0 /B567
//    act_writel((act_readl(MRCR) | 0x000c00), MRCR);  //I2S B0 /B567
//    act_writel(0x0c201, DAC_CTL);
//    act_writel((act_readl( AUDIOPLL_CTL) | 0x0902),  AUDIOPLL_CTL);  
//    act_writel((act_readl(ADC_FIFOCTL) | 0x080b), ADC_FIFOCTL);
