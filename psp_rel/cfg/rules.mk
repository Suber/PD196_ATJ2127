...
# **********************************************
#编译命令行选项
#CC_OPTS_BASE = -g -c -G0 -Wall -Wno-unknown-pragmas $(INCLUDE)  -msoft-float -fsigned-char -mtune=4kec -mips32r2 -nostdinc -nostdlib -fno-builtin $(OFORMAT) $(BUILD_MACRO) 
CC_OPTS_BASE_16 = -g -c -G0 -Wall -Wno-unknown-pragmas $(INCLUDE)  -msoft-float -fsigned-char -fshort-enums -mtune=m4k -mips16e -nostdinc -nostdlib -fno-builtin $(OFORMAT) $(BUILD_MACRO) 
CC_OPTS_BASE = -g -c -G0 -Wall -Wno-unknown-pragmas $(INCLUDE)  -msoft-float -fsigned-char -fshort-enums -mtune=m4k -mips32r2 -nostdinc -nostdlib -fno-builtin $(OFORMAT) $(BUILD_MACRO) 
